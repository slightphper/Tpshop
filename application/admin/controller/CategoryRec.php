...
use think\Db;
class categoryRec extends Controller
{
	//显示分类推荐词
    public function lst()
    {
    	$categoryRes = Db::name('category_rec')->alias('cr')->join('category c','cr.category_id = c.id')->field('cr.*,c.cate_name')->order('cr.id DESC')->paginate(8);
