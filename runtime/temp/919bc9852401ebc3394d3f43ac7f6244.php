<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"E:\phpStudy\WWW\TPshop/application/index\view\flow\paysuccess.htm";i:1541591293;s:63:"E:\phpStudy\WWW\TPshop/application/index\view\common\footer.htm";i:1541318748;}*/ ?>
<!doctype html>
<html>
<head>
...
</script><link rel="stylesheet" type="text/css" href="js/perfect-scrollbar.min.css" />
</head>
    ...
    <div class="w w1200">        
        <div class="shopend-warp">
            ...
            <div class="s-i-right">
                <h3>恭喜支付成功！</h3>
                <div class="s-i-tit">
                    <p>订单号：<em id="nku">2018062518225865403</em></p>
                    <p>配送方式：<em>顺丰速运</em></p>
                    <p>运费：<em><em>¥</em>0.00</em></p>
                    <p>应付总金额：<em><em>¥</em><?php echo $orderInfo['order_total_price']; ?></em></p>
                    <p>收货人：<span id="username"><?php echo $orderInfo['name']; ?></span>
                    <span id="tel" class="ml20"><?php echo $orderInfo['phone']; ?></span></p>
                    <p>寄送至： <span id="address"><?php echo $orderInfo['addr']; ?></span></p>
                </div>
                <div class="s-i-btn">
                    <a href="#" class="btn sc-redBg-btn">查看订单</a>
                   <a href="<?php echo url('index/Index/index'); ?>">返回首页</a>                       
                </div>
             </div>
        </div>
        </div>              
