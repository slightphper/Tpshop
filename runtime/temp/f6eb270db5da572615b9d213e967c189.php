<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"E:\phpStudy\WWW\TPshop/application/admin\view\order\ordergoodsedit.htm";i:1541744501;s:60:"E:\phpStudy\WWW\TPshop/application/admin\view\common\top.htm";i:1540357346;s:61:"E:\phpStudy\WWW\TPshop/application/admin\view\common\left.htm";i:1541849845;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                         ...
                         <li>
                            <a href="<?php echo url('Order/orderGoods',array('id'=>$orderGoodsInfo['order_id'])); ?>">订单商品</a>
                        </li>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="goods_name" value="<?php echo $orderGoodsInfo['goods_name']; ?>" required="" type="text">
                            </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo $orderGoodsInfo['member_price']; ?>" name="member_price" type="text">
                            </div>
                        </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <!-- <input class="form-control" value="<?php echo $orderGoodsInfo['goods_attr_str']; ?>" name="goods_attr_str" type="text"> -->
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                               <input class="form-control" value="<?php echo $orderGoodsInfo['goods_num']; ?>" name="goods_num" type="text">
                            </div>
                        </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                               <input class="form-control" value="<?php echo $orderGoodsInfo['total_price']; ?>" name="total_price" type="text">
                            </div>
                        </div>
...
function orderGoodsEdit(){
    var url = "<?php echo url('Order/orderGoodsEdit',array('id'=>$orderGoodsInfo['id'])); ?>";
    var jump = "<?php echo url('Order/orderGoods',array('id'=>$orderGoodsInfo['order_id'])); ?>";
