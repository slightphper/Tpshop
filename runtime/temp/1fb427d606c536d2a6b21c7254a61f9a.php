<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"E:\phpStudy\WWW\TPshop/application/admin\view\order\detail.htm";i:1541678003;s:60:"E:\phpStudy\WWW\TPshop/application/admin\view\common\top.htm";i:1540357346;s:61:"E:\phpStudy\WWW\TPshop/application/admin\view\common\left.htm";i:1541849845;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <tbody>
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td>
                                <?php echo $orderInfo['goods_total_price']; ?> 元
                            </td>
                        </tr>
                         <tr>
                            <td style="text-align:right;">
                            ...
                            <td>
                                <?php echo $orderInfo['post_spent']; ?> 元
                            </td>
                        </tr>
                         <tr>
                            <td style="text-align:right;">
                            ...
                            <td>
                                <?php echo $orderInfo['order_total_price']; ?> 元
                            </td>
                        </tr>
                         <tr>
                            <td style="text-align:right;">
                         ...
                         <tr>
                            ...
                            <td>
                                <?php echo $orderInfo['mobile_phone']; ?>
                            </td>
                        </tr>
                       <tr>
                            <td style="text-align:right;">
                            ...
                            <td>
                            <?php echo $orderInfo['province']; ?> <?php echo $orderInfo['city']; ?> <?php echo $orderInfo['district']; ?>
                            </td>
                        </tr>
                         <tr>
                            <td style="text-align:right;">
