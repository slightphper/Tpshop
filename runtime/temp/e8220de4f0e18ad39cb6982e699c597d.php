<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"E:\phpStudy\WWW\TPshop/application/admin\view\rec_pos\lst.htm";i:1539754048;s:60:"E:\phpStudy\WWW\TPshop/application/admin\view\common\top.htm";i:1540357346;s:61:"E:\phpStudy\WWW\TPshop/application/admin\view\common\left.htm";i:1541849845;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" width="15%">推荐位状态</th>
                                <th class="text-center" width="15%">操作</th>
                            </tr>
                        </thead>
                        <tbody>
                              <?php if(is_array($rec_posRes) || $rec_posRes instanceof \think\Collection || $rec_posRes instanceof \think\Paginator): $i = 0; $__LIST__ = $rec_posRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rec_pos): $mod = ($i % 2 );++$i;?>
                              <tr>
                                <td align="center"><?php echo $rec_pos['id']; ?></td>
                                <td align="center"><?php echo $rec_pos['rec_name']; ?></td>
                                <td align="center">
                                    <?php if($rec_pos['rec_type'] == 1): ?>
                                        商品推荐
                                    <?php else: ?>
                                        分类推荐
                                    <?php endif; ?>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('RecPos/edit',array('id'=>$rec_pos['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('RecPos/del',array('id'=>$rec_pos['id'])); ?>')" class="btn btn-danger btn-sm shiny">
