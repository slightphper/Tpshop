<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\phpStudy\WWW\TPshop/application/admin\view\order\ordergoods.htm";i:1541744341;s:60:"E:\phpStudy\WWW\TPshop/application/admin\view\common\top.htm";i:1540357346;s:61:"E:\phpStudy\WWW\TPshop/application/admin\view\common\left.htm";i:1541849845;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" width="11%">商品名称</th>
                                <th class="text-center" width="8%">购买价格</th>
                                <th class="text-center" width="8%">商品属性</th>
                                <th class="text-center" width="8%">购买数量</th>
                                <th class="text-center" width="8%">总价</th>
                                <th class="text-center" width="10%">操作</th>
                            </tr>
                        </thead>
                        <tbody>
                              <?php if(is_array($orderGoods) || $orderGoods instanceof \think\Collection || $orderGoods instanceof \think\Paginator): $i = 0; $__LIST__ = $orderGoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$orderGoods): $mod = ($i % 2 );++$i;?>
                              <tr>
                                <td align="center"><?php echo $orderGoods['id']; ?></td>
                                <td align="left"><?php echo cut_str($orderGoods['goods_name'],13); ?></td>
                                <td align="center"><?php echo $orderGoods['member_price']; ?> 元</td>
                                <td align="left"><?php echo $orderGoods['goods_attr_str']; ?></td>
                                <td align="center">x <?php echo $orderGoods['goods_num']; ?></td>
                                <td align="center"><?php echo $orderGoods['total_price']; ?> 元</td>
                               
                                <td align="center">
                                    <a href="<?php echo url('order/orderGoodsEdit',array('id'=>$orderGoods['id'])); ?>" class="btn btn-azure btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="orderGoodsDel(this)" id="<?php echo $orderGoods['id']; ?>" class="btn btn-danger btn-sm shiny">
...
function orderGoodsDel(obj){
    if(!confirm('确定要从订单中删除该商品？')){
        return false;
    }
    var url = "<?php echo url('order/orderGoodsDel'); ?>";
    var order_goods_id = $(obj).attr('id');
