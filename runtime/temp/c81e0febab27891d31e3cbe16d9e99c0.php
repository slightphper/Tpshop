<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"E:\phpStudy\WWW\TPshop/application/index\view\flow\flowcart2.htm";i:1541487416;s:63:"E:\phpStudy\WWW\TPshop/application/index\view\common\footer.htm";i:1541318748;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="ck-step" id="consignee_list">
    ...
    <div class="form-row">
        ...
        <div class="form-value">
            <input type="text" name="name" value="" class="form-input"><div class="form_prompt">
        </div></div>
    </div>
    <div class="form-row">
    ...
    <div class="ck-step-cont">
        <div class="payment-warp">
            <div class="payment-list" ectype="paymentType">
                ...
                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
                    <span>
                        <input type="radio" name="payment" />微信    
                    </span>
                    <b></b>
                </div>
            </div>
...
<div class="c-col cg-name">
        ...
        <div class="p-img"><img src="__index__/img/0_thumb_G_1490209495581.jpg" width="48" height="48"></div>
        <div class="p-info">
            <div class="p-name">Sony/索尼 KDL-48W650D 48英寸液晶高清 wifi网络 平板电视 正品保证 三期免息 咨询有礼 售后上门</div>
            <div class="p-attr"></div>
        </div>
    </a>
    </div>
<div class="c-col cg-price">
    <span class="fr cl"><em>¥</em>3499.00</span>
    </div>
<div class="c-col cg-number">x1</div>
...
<div class="c-col cg-sum"><em>¥</em>3499.00</div>
...
<div class="c-col cg-name">
            ...
            <a href="goods.php?id=813" target="_blank">
        <div class="p-img"><img src="__index__/img/0_thumb_G_1490203982198.jpg" width="48" height="48"></div>
        <div class="p-info">
            <div class="p-name">小吉 宝宝儿童家用小型全自动婴儿迷你滚筒洗衣机高温煮洗杀菌 杀菌安全 DD变频电机 睡眠级静音</div>
            <div class="p-attr"></div>
        </div>
    </a>
    </div>
<div class="c-col cg-price">
    <span class="fr cl"><em>¥</em>2099.00</span>
    </div>
<div class="c-col cg-number">x2</div>
<div class="c-col cg-state">
    <span>
    有货            <input name="rec_number" type="hidden" id="36" value="0">
                    <input name="shipping_prompt" type="hidden" id="36" value="1">
                            </span>
</div>
<div class="c-col cg-sum"><em>¥</em>4198.00</div>
<div class="cg-item-line"></div>
<i class="dian"></i>
            </div>
...
<div class="order-summary">
    <div class="statistic">
        <div class="list">
            <span><em>3</em> 件商品，总商品金额：</span>
            <em class="price" id="warePriceId"><em>¥</em>7697.00</em>
        </div>
<div class="list">
            <span>应付总额：</span>
            <em class="price-total"><em>¥</em>7697.00</em>
        </div>
    </div>
</div>   
