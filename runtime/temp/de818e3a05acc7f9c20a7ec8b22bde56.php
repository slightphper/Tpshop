<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"E:\phpStudy\WWW\TPshop/application/admin\view\article\add.htm";i:1539690491;s:60:"E:\phpStudy\WWW\TPshop/application/admin\view\common\top.htm";i:1540357346;s:61:"E:\phpStudy\WWW\TPshop/application/admin\view\common\left.htm";i:1541849845;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal" role="form" action="<?php echo url('Article/add'); ?>" method="post" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="cate_id">
                                    ...
                                    <?php if(in_array(($cate['id']), explode(',',"1,2"))): ?> disabled="disabled" <?php endif; ?>>
                                    <?php echo str_repeat('--',$cate['level']*2) ?><?php echo $cate['cate_name']; endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="radio" style="float:left;">
                                <label>
                                    <input name="show_top" value="0" class="colored-blue" type="radio" checked="checked">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <div class="radio" style="float:left; padding-right:10px;">
                                <label>
                                    <input name="show_status" value="1" class="colored-blue"  type="radio" checked="checked">
