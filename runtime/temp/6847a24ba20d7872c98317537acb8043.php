<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"E:\phpStudy\WWW\TPshop\public/../application/admin\view\type\lst.htm";i:1538881048;s:70:"E:\phpStudy\WWW\TPshop\public/../application/admin\view\common\top.htm";i:1540357346;s:71:"E:\phpStudy\WWW\TPshop\public/../application/admin\view\common\left.htm";i:1540261124;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                              ...
                              <tr>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('attr/lst',array('type_id'=>$type['id'])); ?>" class="btn btn-darkorange btn-sm shiny">
                                     ...
                                     <a href="<?php echo url('type/edit',array('id'=>$type['id'])); ?>" class="btn btn-azure btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('type/del',array('id'=>$type['id'])); ?>')" class="btn btn-danger btn-sm shiny">
