<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"E:\phpStudy\WWW\TPshop/application/admin\view\brand\lst.htm";i:1538189325;s:60:"E:\phpStudy\WWW\TPshop/application/admin\view\common\top.htm";i:1540357346;s:61:"E:\phpStudy\WWW\TPshop/application/admin\view\common\left.htm";i:1541833183;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                        ...
                        <tbody>
                              ...
                              <tr>
                                ...
                                <?php if($brand['brand_img'] != ''): ?>
                                    <img src="__uploads__/<?php echo $brand['brand_img']; ?>" height="30">
                                <?php else: ?>
                                    暂无Logo
                                <?php endif; ?>
                                </td>
                                <td><?php echo cut_str($brand['brand_description'],14); ?></td>
                                <td align="center">
                                    <?php if($brand['status'] == 1): ?>
                                        <img src="__admin__/images/right.png">
                                    <?php else: ?>
                                        <img src="__admin__/images/wrong.png">
                                    <?php endif; ?>
                                </td>
                                <td align="center">
                                    <a href="<?php echo url('brand/edit',array('id'=>$brand['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('brand/del',array('id'=>$brand['id'])); ?>')" class="btn btn-danger btn-sm shiny">
