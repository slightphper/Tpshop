<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"E:\phpStudy\WWW\TPshop/application/admin\view\order\lst.htm";i:1541826860;s:60:"E:\phpStudy\WWW\TPshop/application/admin\view\common\top.htm";i:1540357346;s:61:"E:\phpStudy\WWW\TPshop/application/admin\view\common\left.htm";i:1541849845;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<div class="page-body">
<div>             
<button type="button" tooltip="订单查询" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Order/orderSelect'); ?>'">
 <i class="fa fa-plus"></i> 订单查询
</button>
<button type="button" tooltip="全部订单" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Order/lst'); ?>'">
 <i class="fa fa-plus"></i> 全部订单
</button>
<button type="button" tooltip="已支付" class="btn btn-sm btn-palegreen btn-addon" onClick="javascript:window.location.href = '<?php echo url('Order/lst'); ?>?status=paied'">
 <i class="fa fa-plus"></i> 已支付
</button>
<button type="button" tooltip="未支付" class="btn btn-sm btn-darkorange btn-addon" onClick="javascript:window.location.href = '<?php echo url('Order/lst'); ?>?status=no_paied'"> 
<i class="fa fa-plus"></i> 未支付
</button>
<button type="button" tooltip="已发货" class="btn btn-sm btn-blue btn-addon" onClick="javascript:window.location.href = '<?php echo url('Order/lst'); ?>?status=posted'">
 <i class="fa fa-plus"></i> 已发货
</button>
<button type="button" tooltip="未发货" class="btn btn-sm btn-darkorange btn-addon" onClick="javascript:window.location.href = '<?php echo url('Order/lst'); ?>?status=no_posted'">
 <i class="fa fa-plus"></i> 未发货
</button>
<button type="button" tooltip="已签收" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Order/lst'); ?>?status=receive'">
 <i class="fa fa-plus"></i> 已签收
</button>
<button type="button" style="margin-left:440px;height:30px;" class="btn btn-sm btn-danger btn-addon" onClick="javascript:window.location.href = '<?php echo url('Order/exportOrders'); ?>?status=<?php echo $orderStatus; ?>'">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                              ...
                              <tr>
                                ...
                                <td align="center"><?php echo $order['order_total_price']; ?>元</td>
                                <td align="center">
                                   <?php if($order['pay_status'] == 0): ?>未支付<?php else: ?>已支付<?php endif; ?> 
                                </td>
                                <td align="center">
                                    <?php if($order['order_status'] == 0): ?>未确认<?php else: ?>已确认<?php endif; ?>
                                </td>
                                <td align="center">
                                    <?php if($order['post_status'] == 0): ?>未发货
                                    <?php elseif($order['post_status'] == 1): ?>已发货
                                    <?php elseif($order['post_status'] == 2): ?>已签收
                                    <?php endif; ?>
                                </td>
                                <td align="center"><?php echo $order['distribution']; ?></td>
                               <!--  <td align="center">
                                    <?php if($order['payment'] == 1): ?>支付宝<?php else: ?>微信<?php endif; ?>
                                </td> -->
                                <td align="center"><?php echo $order['username']; ?></td>
                                <!-- <td align="center"><?php echo $order['name']; ?></td> -->
                                <!-- <td align="center"><?php echo $order['mobile_phone']; ?></td> -->
                                <td align="center"><?php echo date("Y-m-d H:i",$order['order_time']); ?></td>
                              
                                <td align="center">
                                     <a href="<?php echo url('Order/orderGoods',array('id'=>$order['id'])); ?>" class="btn btn-palegreen btn-sm shiny">
                                        <i class="fa fa-shopping-cart"></i> 订单商品
                                    </a>
                                    <a href="<?php echo url('Order/detail',array('id'=>$order['id'])); ?>" class="btn btn-darkorange btn-sm shiny">
                                        <i class="fa fa-list"></i> 订单详情
                                    </a>
                                    <a href="<?php echo url('order/edit',array('id'=>$order['id'])); ?>" class="btn btn-azure btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="del(this)" id="<?php echo $order['id']; ?>" class="btn btn-danger btn-sm shiny">
