<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"E:\phpStudy\WWW\TPshop/application/admin\view\article\lst.htm";i:1539581614;s:60:"E:\phpStudy\WWW\TPshop/application/admin\view\common\top.htm";i:1540357346;s:61:"E:\phpStudy\WWW\TPshop/application/admin\view\common\left.htm";i:1541849845;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" width="10%">图文标题</th>
                                <th class="text-center" width="8%">所属分类</th>
                                <th class="text-center" width="8%">是否置顶</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td ><?php echo cut_str($art['title'],15); ?></td>
                                <td align="center">
                                    <?php if($art['thumb'] != ''): ?>
                                    <img src="__uploads__/<?php echo $art['thumb']; ?>" height="40">
                                    <?php else: ?>暂无图片
                                    <?php endif; ?>
                                </td>
                                <td align="center"><?php echo $art['cate_name']; ?></td>
                                <td align="center"><?php if($art['show_top'] == 1): ?>
                                    <img src="__admin__/images/right.png" height="25">
                                <?php else: ?>
                                    <img src="__admin__/images/wrong.png" height="22">
                                <?php endif; ?>
                                </td>
                                <td align="center"><?php if($art['show_status'] == 1): ?>
                                    <img src="__admin__/images/right.png" height="25">
                                <?php else: ?>
                                    <img src="__admin__/images/wrong.png" height="22">
                                <?php endif; ?>
                                </td>
                                <td align="center"><?php echo date("Y-m-d",$art['addtime']); ?></td>
                                <td align="center">
