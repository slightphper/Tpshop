<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"E:\phpStudy\WWW\TPshop\public/../application/index\view\article\article.htm";i:1539665002;s:73:"E:\phpStudy\WWW\TPshop\public/../application/index\view\common\header.htm";i:1540887764;s:76:"E:\phpStudy\WWW\TPshop\public/../application/index\view\common\cate_left.htm";i:1539664995;s:73:"E:\phpStudy\WWW\TPshop\public/../application/index\view\common\footer.htm";i:1540798310;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="content article-content">
    <div class="w w1200 clearfix">
     ...
     <dl class="article-menu">
        <dt class="am-t"><a href="#">帮助中心首页</a></dt>
        <!-- 系统分类 -->
        <dd class="am-c">
            <div class="menu-item active">
            <div class="item-hd"><a href="">消费者帮助</a><i class="iconfont icon-down"></i></div>
                <ul class="item-bd"></ul>
                <ul class="item-bd">
                        <?php if(is_array($helpCates) || $helpCates instanceof \think\Collection || $helpCates instanceof \think\Paginator): $i = 0; $__LIST__ = $helpCates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hCates): $mod = ($i % 2 );++$i;?>
                        <li><a href="<?php echo url('index/Cate/index',array('id'=>$hCates['id'])); ?>"><?php echo $hCates['cate_name']; ?></a></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
            </div>
        </dd>
       <!-- 普通分类 -->
        ...
        <div class="article-main">
            <div class="am-hd">
                ...
                <div class="extra">
					<?php if(is_array($position) || $position instanceof \think\Collection || $position instanceof \think\Paginator): $i = 0; $__LIST__ = $position;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$position): $mod = ($i % 2 );++$i;?>
				    <a href="<?php echo url('index/Cate/index',array('id'=>$position['id'])); ?>"><?php echo $position['cate_name']; ?></a>
			    	<i>&gt;</i>
			  		<?php endforeach; endif; else: echo "" ;endif; ?>
...
var register = "<?php echo url('member/Account/register'); ?>";
</script>
