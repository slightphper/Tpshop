<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"E:\phpStudy\WWW\TPshop\public/../application/admin\view\conf\lst.htm";i:1538787600;s:70:"E:\phpStudy\WWW\TPshop\public/../application/admin\view\common\top.htm";i:1540357346;s:71:"E:\phpStudy\WWW\TPshop\public/../application/admin\view\common\left.htm";i:1540261124;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" width="18%">默认值</th>
                        ...
                        <tbody>
                              ...
                              <tr>
                                ...
                                <td align="center">
                                <?php if($conf['values'] != ''): ?>
                                <?php echo $conf['values']; else: ?>无<?php endif; ?>
                                </td>
                                <td align="center">
                                <?php if($conf['form_type'] == 'file'): ?>
                                <img src="__uploads__/<?php echo $conf['value']; ?>" height="30" >
                                <?php elseif($conf['value'] != ''): ?><?php echo $conf['value']; else: ?>暂无默认值
                                <?php endif; ?>
                                </td>
                                <td align="center">
                                    <input type="text" style="width:50px;text-align:center;" name="<?php echo $conf['id']; ?>" value="<?php echo $conf['sort']; ?>">
                                </td>
                                <td align="center">
                                    <a href="<?php echo url('Conf/edit',array('id'=>$conf['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('Conf/del',array(
                                    'id'=>$conf['id'])); ?>')" class="btn btn-danger btn-sm shiny">
