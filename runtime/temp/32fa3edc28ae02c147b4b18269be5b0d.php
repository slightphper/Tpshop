<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\phpStudy\WWW\TPshop/application/admin\view\member_level\lst.htm";i:1538983491;s:60:"E:\phpStudy\WWW\TPshop/application/admin\view\common\top.htm";i:1540357346;s:61:"E:\phpStudy\WWW\TPshop/application/admin\view\common\left.htm";i:1541833183;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                              ...
                              <tr>
                                ...
                                <td align="center">
                                     <a href="<?php echo url('MemberLevel/edit',array('id'=>$ml['id'])); ?>" class="btn btn-azure btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('MemberLevel/del',array('id'=>$ml['id'])); ?>')" class="btn btn-danger btn-sm shiny">
