<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"E:\phpStudy\WWW\TPshop\public/../application/member\view\account\login.htm";i:1540902914;}*/ ?>
<!doctype html>
<html>
<head>
...
<script type="text/javascript">
var check_login = "<?php echo url('member/Account/login'); ?>";
var shop_index = "<?php echo url('index/Index/index'); ?>";
</script>
</head>
                ...
                <div class="login-form">
                    <div class="coagent">
                        ...
                        <div class="coagent-warp">
                            <a href="#" class="qq">
                            <b class="third-party-icon qq-icon"></b></a>
                          </div>
                    </div>
                    <div class="login-box">
