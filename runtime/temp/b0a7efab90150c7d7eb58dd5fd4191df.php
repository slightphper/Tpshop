<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"E:\phpStudy\WWW\TPshop\public/../application/admin\view\goods\product.htm";i:1539395670;s:70:"E:\phpStudy\WWW\TPshop\public/../application/admin\view\common\top.htm";i:1540357346;s:71:"E:\phpStudy\WWW\TPshop\public/../application/admin\view\common\left.htm";i:1540261124;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                              ...
                              ?>
                                <tr>
                                 <?php foreach($radioAttrRes as $k=>$v):?>
                                    <td align="center">
                                        <select name="goods_attr[<?php echo $k; ?>][]" class="select1">
                                    ...
                                    <td align="center"><input type="text" name="goods_num[]" value="<?php echo $v0['goods_number']?>"></td>
                                    <td align="center">
                                         <a href="javascript:;" onclick="addNum(this)" class="btn btn-azure btn-sm shiny"><?php if($k0 == 0){echo '+';}else{echo '-';}?></a>
                                    </td>
                                 </tr>
                              <?php endforeach; else:?>
                              <tr>
                                ...
                                <td align="center">
                                     <a href="javascript:;" onclick="addNum(this)" class="btn btn-azure btn-sm shiny">+</a>
                                    <!-- <a href="javascript:;" class="btn btn-danger btn-sm shiny">-</a> -->
                                </td>
                            </tr>
                            <?php endif;?>                       
                      </tbody>
