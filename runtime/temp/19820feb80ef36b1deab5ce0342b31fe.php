<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"E:\phpStudy\WWW\TPshop\public/../application/index\view\index\index.htm";i:1540795063;s:73:"E:\phpStudy\WWW\TPshop\public/../application/index\view\common\header.htm";i:1541318416;s:73:"E:\phpStudy\WWW\TPshop\public/../application/index\view\common\footer.htm";i:1541318748;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="homeindex" ectype="homeWrap">                 
	...
	<div class="bd">
    	<ul data-type="range">
            <?php if(is_array($alterImgRes) || $alterImgRes instanceof \think\Collection || $alterImgRes instanceof \think\Paginator): $i = 0; $__LIST__ = $alterImgRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$alterImgs): $mod = ($i % 2 );++$i;?>
	        <li style="background:url(__uploads__/<?php echo $alterImgs['img_src']; ?>) center center no-repeat;">
            <div class="banner-width"><a href="#" style="height:500px;"></a></div></li>
    	    <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
...
<div ectype="user_info">
    ...
    <div class="login-info">
        <span>Hi，欢迎来到<?php echo $configs['shop_name']; ?>！</span>
...
<div class="vip-item">
    ...
    <div class="con">
        <ul>
            <?php if(is_array($noticeArts) || $noticeArts instanceof \think\Collection || $noticeArts instanceof \think\Paginator): $i = 0; $__LIST__ = $noticeArts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nArts): $mod = ($i % 2 );++$i;?>
            <li><a href="<?php echo url('index/Article/index',array('id'=>$nArts['id'])); ?>" target="_blank"><?php echo $nArts['title']; ?></a></li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
        <ul style="display:none;">
            <?php if(is_array($saleArts) || $saleArts instanceof \think\Collection || $saleArts instanceof \think\Paginator): $i = 0; $__LIST__ = $saleArts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sArts): $mod = ($i % 2 );++$i;?>
            <li><a href="<?php echo url('index/Article/index',array('id'=>$sArts['id'])); ?>" target="_blank"><?php echo $sArts['title']; ?></a></li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    </div>
</div>
...
<!-- 中部品牌推荐结束 -->
<!-- 大分类推荐开始 * 赋值为$categoryRec -->
 <?php foreach($categoryRec as $k => $v):?>
    ...
    <div class="floor-bd bd-mode-01">
        <div class="bd-left">
            <div class="floor-left-slide">
                <div class="bd">
                    <ul>
                        <?php if(isset($v['advImg']['A'])):foreach($v['advImg']['A'] as $k6 => $v6):?>
                        <li>
                         <a href="#"><img src="__uploads__/<?php echo $v6['img_src']?>"></a>
                        </li>
            ...
            <div class="floor-left-adv">
                <?php if(isset($v['advImg']['B'][0]['img_src'])):?>
                <a href="#" target="_blank">
                    <img src="__uploads__/<?php echo $v['advImg']['B'][0]['img_src'];?>">
                </a>
                <?php endif;if(isset($v['advImg']['C'][0]['img_src'])):?>
                <a href="#" target="_blank">
                    <img src="__uploads__/<?php echo $v['advImg']['C'][0]['img_src']?>">
                </a>
            <?php endif;?>
            </div>  
     </div>
...
<div class="bd-right">
    <div class="floor-tabs-content clearfix">
		...
		<!-- 新品推荐开始 -->
		<ul class="p-list">
		<?php foreach($v['newRecGoods'] as $k2 => $v2):?>
			<li class="opacity_img">
			    <div class="product">
			        <div class="p-img">
			        <a target="_blank" href="goods.php?id=801">
			        	<img width="140" height="140" src="__uploads__/<?php echo $v2['mid_thumb'];?>">
			        </a></div>
			        <div class="p-name">
			        <a title="<?php echo $v2['goods_name'];?>" href="#"><?php echo $v2['goods_name']?></a>
			        </div>
                    <div class="p-price">
                        <div class="shop-price">
                             <em>¥</em><?php echo $v2['shop_price'];?> 
                        </div>
                        <div class="original-price"><em>¥</em></div>
                    </div>
			    </div>
			</li>
		<?php endforeach;?>
...
<!-- 新品推荐结束 -->
    ...
    <!-- 对应推荐分类->精选推荐 商品显示 -->
    <?php foreach($v['children'] as $k3 => $v3):?> 
    <div class="f-r-main" ectype="floor_cat_347">
         <ul class="p-list">
            <?php foreach($v3['bestGoods'] as $k4 => $v4):?>
            <li class="opacity_img">
                <div class="product">
                    <div class="p-img">
                    <a target="_blank" href="goods.php?id=801">
                        <img width="140" height="140" src="__uploads__/<?php echo $v4['mid_thumb'];?>">
                    </a></div>
                    <div class="p-name">
                    <a title="<?php echo $v4['goods_name'];?>" href="#"><?php echo $v4['goods_name']?></a>
                    </div>
                    <div class="p-price">
                        <span class="shop-price">
                            <em>¥</em><?php echo $v4['shop_price'];?>
                        </span>
                        <span class="original-price"><em>¥</em><?php echo $v4['markte_price'];?></span>
                    </div>
                </div>
            </li>
            <?php endforeach;?>
    ...
    <div class="floor-fd">
        <div class="floor-fd-brand clearfix">
            <?php foreach($v['brands']['brands'] as $k5 => $v5):?>
            <div class="item">
                <a href="#" target="_blank">
                    <div class="link-l"></div>
                    <div class="img">
                        <img src="__uploads__/<?php echo $v5['brand_img'];?>" title="<?php echo $v5['brand_name']?>">
                    </div>
                    <div class="link"></div>
                </a>
            </div>
...
<div class="visual-item w1200" data-mode="homeFloor" data-purebox="homeFloor" data-li="1" ectype="visualItme" data-diff="1" style="display: block; position: relative; opacity: 1; z-index: 0; left: 0px; top: 0px;">
     ...
     <div class="view">                            
         <div class="view">
            <div class="spec" data-spec="" data-title="店铺"></div>
        </div>
    </div>
</div>
...
<div class="visual-item w1200" data-mode="guessYouLike" data-purebox="goods" ectype="visualItme" data-diff="0" style="display: block;">
    ...
    <div data-goodstitle="title"><div class="ftit"><h3>还没逛够</h3></div></div>
        <ul>
            ...
            <li class="opacity_img">
                 <a href="#" target="_blank">
                    <div class="p-img"><img src="__uploads__/<?php echo $indexgoods['og_thumb']; ?>"></div>
                    ...
                    <div class="p-price">
                        ...
                        <div class="original-price"><em>¥</em><?php echo $indexgoods['markte_price']; ?></div>
                    </div>
                </a>
            </li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
...
<script type="text/javascript">
var login_url = "<?php echo url('member/Account/checkLogin'); ?>";  //判断是否登录
var logout_url = "<?php echo url('member/Account/logout'); ?>";     //退出
var login = "<?php echo url('member/Account/login'); ?>";
var register = "<?php echo url('member/Account/reg'); ?>";
var cart_goods_num = "<?php echo url('index/Flow/cartGoodsNum'); ?>";  //购物车数量
</script>
