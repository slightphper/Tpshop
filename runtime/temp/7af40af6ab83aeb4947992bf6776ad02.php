<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"E:\phpStudy\WWW\TPshop\public/../application/member\view\account\reg.htm";i:1541074789;}*/ ?>
<!doctype html>
<html>
<head>
                        ...
                        <form action="" method="post" name="formUser">
                           ...
                           <div class="item" id="code_mobile">
                                ...
                                <div class="item-info">
                                    ...
                                    <!-- <a href="javascript:sendChangePhone();" id="zphone" class="sms-btn">获取验证码</a> -->
                                    <input type="botton" id="btn" class="sms-btn" onclick="sendChangePhone();" value="获取验证码">
                                </div>
                                <div class="input-tip"></div>
                            </div>
                            ...
                            <div class="item" id="code_email" ><!-- style="display:none;" -->
                                ...
                                <div class="item-info">
                                   ...
                                   <input type="botton" id="email_btn" onclick="sendChangeEmail();" class="sms-btn" value="获取验证码">
                                </div>
                                <div class="input-tip"></div>
                            </div>
...
$(function(){
    if($.cookie('email') != undefined && $.cookie('email') != 'NaN' && $.cookie('email') != 'null'){
        emailTimekeeping();
    }else{
