<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"E:\phpStudy\WWW\TPshop/application/index\view\flow\flowCart1.htm";i:1541487330;s:63:"E:\phpStudy\WWW\TPshop/application/index\view\common\footer.htm";i:1541318748;}*/ ?>
<!doctype html>
<html>
<head>
...
<script type="text/javascript">
//定义ajax实时计算购物车合计， js：checkAll.js
var ajax_cart_total = "<?php echo url('index/Flow/cartTotal'); ?>";  
//异步删除勾选删除，重定向地址   js: dec-common.js 
var cart_list = "<?php echo url('index/Flow/flowCart1'); ?>";
//异步修改商品数量		js: flowcart1.htm
var ajax_update_cart = "<?php echo url('index/Flow/updateCart'); ?>";
</script>
</head>
...
<div class="cart-table">
         ...
         <div class="item-form">
           <div class="cell s-checkbox">
			<div class="cart-checkbox" ectype="ckList">
				<!-- 复选框问题 ，之前存入商品id<?php echo $cart_goods['id']; ?>，有bug。
					原因：存入商品id如果有不同属性商品，其共用一个id值，无法做购物车操作,现改为数组的键值 <?php echo $key; ?> ->'1-3,4'  -->
			    <input type="checkbox" id="checkItem_<?php echo $key; ?>" value="<?php echo $key; ?>" name="checkItem" class="ui-checkbox" ectype="ckGoods">
			    <label for="checkItem_<?php echo $key; ?>" class="ui-label-14">&nbsp;</label>
			</div>
          </div>
     <div class="cell s-goods">
        ...
        <div class="cell s-quantity">
			<div class="amount-warp">
            	<input type="text" value="<?php echo $cart_goods['goods_num']; ?>" name="goods_number[8]" id="goods_number_8" onchange="change_goods_number('<?php echo $key; ?>', this.value, 2, 16)" class="text buy-num" ectype="number" defaultnumber="1">
		        <div class="a-btn">
	    	        <a href="#" onclick="changenum('<?php echo $key; ?>', 1, 2, 16,17,this)" class="btn-add"><i class="iconfont icon-up"></i></a>
		       		<a href="#" onclick="changenum('<?php echo $key; ?>', -1, 2, 16,17,this)" <?php if($cart_goods['goods_num'] == 1): ?> class="btn-reduce btn-disabled"<?php else: ?> class="btn-reduce"<?php endif; ?>> <i class="iconfont icon-down"></i></a>
		        </div>
    		</div>
        ...
        <div class="cell s-sum">
			<strong id="goods_subtotal_8"><font id="_8_subtotal"><em>¥</em><?php echo $cart_goods['subtotal']; ?></font></strong>
        ...
        <div class="cell s-action">
			<a href="#" id="remove_8" ectype="cartOperation" data-value="{&quot;divId&quot;:&quot;cart_remove&quot;,&quot;url&quot;:&quot;<?php echo url('index/Flow/delCart',array('id_attr'=>$key),''); ?>&quot;,&quot;cancelUrl&quot;:&quot;flow.php?step=drop_to_collect&amp;id=8&quot;,&quot;recid&quot;:8,&quot;title&quot;:&quot;删除&quot;}" class="cart-remove">删除</a>
 ...
 <!-- 商品列表结束 -->
    ...
    <div class="cart-checkbox cart-all-checkbox" ectype="ckList">
	    ...
	    <div class="operation">
	    <!--批量删除购物车商品      js：dec-common.js //1164 -->
        <a href="#" class="cart-remove-batch" data-dialog="remove_collect_dialog" data-divid="cart-remove-batch" data-removeurl="<?php echo url('Flow/delCarts'); ?>" data-collecturl="ajax_dialog.php?act=drop_to_collect" data-title="删除">删除选中的商品</a>
    ...
    <div class="toolbar-right">
        <div class="comm-right">
            <div class="btn-area">
                <!-- 去支付  需判断用户是否登录，未登录跳出登录框，已登录转跳支付页面 -->
                <form name="formCart" method="post" action="<?php echo url('index/flow/flowCart2'); ?>" onsubmit="return get_toCart();">
                    <input name="goPay" type="submit" class="submit-btn" value="去支付" 
                    <?php if(\think\Request::instance()->session('username') == ''): ?> id="go_pay"<?php endif; ?>  
                    data-url=""/> 
...
<script type="text/javascript" src="__index__/js/checkAll.js"></script>    
    <script type="text/javascript">
        ...
        function change_goods_number(rec_id, goods_number, warehouse_id, area_id, cValue, favourable_id){
            ...
            Ajax.call(ajax_update_cart, 'rec_id=' + rec_id + '&sel_id=' + str + '&sel_flag=' + 'cart_sel_flag' +'&goods_number=' + goods_number +'&cValue=' + cValue +'&warehouse_id=' + warehouse_id +'&area_id=' + area_id +'&favourable_id=' + favourable_id, change_goods_number_response, 'POST','JSON');                
        }
