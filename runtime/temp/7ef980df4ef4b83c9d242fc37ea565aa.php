<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"E:\phpStudy\WWW\TPshop/application/admin\view\user\edit.htm";i:1541848308;s:60:"E:\phpStudy\WWW\TPshop/application/admin\view\common\top.htm";i:1540357346;s:61:"E:\phpStudy\WWW\TPshop/application/admin\view\common\left.htm";i:1541833183;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('User/edit'); ?>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo $users['id']; ?>">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">用户名称</label>
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="username" value="<?php echo $users['username']; ?>" required="" type="text">
                            </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="不填写默认不修改密码" name="password" type="password">
                            </div>
                            <p class="help-block col-sm-4 red">* 不填写默认不修改密码</p>
                        </div>

                         <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">电话</label>
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="mobile_phone" value="<?php echo $users['mobile_phone']; ?>" type="text">
                            </div>
                        </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="email" value="<?php echo $users['email']; ?>" type="text">
                            </div>
                        </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="points" value="<?php echo $users['points']; ?>"  type="text">
                            </div>
                        </div>
