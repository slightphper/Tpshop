<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"E:\phpStudy\WWW\TPshop/application/index\view\flow\flowcart4.htm";i:1541667538;s:63:"E:\phpStudy\WWW\TPshop/application/index\view\common\footer.htm";i:1541318748;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="w w1200">
        <div class="fl">
            <div class="city-choice" id="city-choice" data-ectype="dorpdown">
    	       <div class="dorpdown-layer" ectype="dsc-choie-content"></div>
            </div>
        ...
        <div class="payOrder-warp" id="pay_main">
            <div class="payOrder-desc">
                <div class="pay-top">
                    ...
                    <div class="pay-total">
                        <span>应付总额：</span>
                        <div class="pay-price">￥<?php echo $orderInfo['goods_total_price']; ?></div>
                    </div>
                </div>
                <div class="pay-txt">
            ...
            <div class="o-list">
                <div class="o-list-info">
                    <span id="shdz">寄送至：<?php echo $orderInfo['province']; ?> <?php echo $orderInfo['city']; ?> <?php echo $orderInfo['district']; ?>  &nbsp;&nbsp;<?php echo $orderInfo['address']; ?></span>
                    <span id="shr">收货人：<?php echo $orderInfo['name']; ?></span>
                    <span id="mobile">电话：<?php echo $orderInfo['mobile_phone']; ?></span>
                    <span><hr/></span>
                </div>
            </div>
                ...
                <?php if($orderInfo['payment'] == 1): ?>
                    <?php echo $payBtn; else: ?>
                    <span><img src="__index__/img/wxpay-icon.png" alt=""></span>
                    <img src="<?php echo url('index/Flow/wxewm',array('outTradeNo'=>$orderInfo['out_trade_no']),''); ?>" >
                <?php endif; ?>

                <!-- 测试支付按钮 -->
                <form action="<?php echo url('index/flow/paySuccess'); ?>" method="post" style="margin-top:20px">
                   <input type="submit" class="paybtn" value="支付测试">
                   <input type="hidden" name="order_name" value="<?php echo $orderInfo['name']; ?>">
                   <input type="hidden" name="order_price" value="<?php echo $orderInfo['order_total_price']; ?>">
                   <input type="hidden" name="order_phone" value="<?php echo $orderInfo['mobile_phone']; ?>">
                   <input type="hidden" name="order_addr" value="<?php echo $orderInfo['address']; ?>">
                </form>
            </div>
