<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"E:\phpStudy\WWW\TPshop/application/admin\view\order\orderselect.htm";i:1541754288;s:60:"E:\phpStudy\WWW\TPshop/application/admin\view\common\top.htm";i:1540357346;s:61:"E:\phpStudy\WWW\TPshop/application/admin\view\common\left.htm";i:1541849845;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('Order/lst'); ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                           
                            <div class="col-sm-6" style="width:830px;">
                                <select name="select_base" style="float:left;margin:0px 10px 0px 50px;">
                                    <option value="out_trade_no">订单号</option>
                                    <option value="username">用户名</option>
                                </select>
                                <input class="form-control" style="width:400px; float:left;" name="select_value" required="" type="text">
                    
                                <button type="submit" style="width:100px;margin-left:20px" class="btn btn-default">查询</button>
                            </div>
                        </div>
                    </form>
                </div>
