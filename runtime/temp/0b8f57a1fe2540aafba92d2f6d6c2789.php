<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"E:\phpStudy\WWW\TPshop\public/../application/admin\view\category\edit.htm";i:1540283721;s:70:"E:\phpStudy\WWW\TPshop\public/../application/admin\view\common\top.htm";i:1540357346;s:71:"E:\phpStudy\WWW\TPshop\public/../application/admin\view\common\left.htm";i:1540261124;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('Category/edit'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="pid">
                                    ...
                                    <option value="<?php echo $cate['id']; ?>" <?php if($categorys['pid'] == $cate['id']): ?> selected="selected" <?php endif; ?>>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="cate_name" value="<?php echo $categorys['cate_name']; ?>" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>

                       <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">分类图标</label>
                            <div class="col-sm-6">
                              <div class="radio" style="float:left; padding-right:10px;">
                                <label>
                                <input name="cate_icon" value="icon-ele" class="colored-blue" type="radio">
                                    <span class="text">家用电器类</span>
                                </label>
                                </div>
                                <div class="radio" style="float:left; padding-right:10px;">
                                <label>
                                <input name="cate_icon" value="icon-digital" class="colored-blue" type="radio" >
                                    <span class="text">手机数码类</span>
                                </label>
                                </div>
                                 <div class="radio" style="float:left; padding-right:10px;">
                                <label>
                                <input name="cate_icon" value="icon-computer" class="colored-blue" type="radio" >
                                    <span class="text">电脑办公类</span>
                                </label>
                                </div>
                                  <div class="radio" style="float:left; padding-right:10px;">
                                <label>
                                <input name="cate_icon" value="icon-clothes" class="colored-blue" type="radio" >
                                    <span class="text">服饰类</span>
                                </label>
                                </div>
                                  <div class="radio" style="float:left; padding-right:10px;">
                                <label>
                                <input name="cate_icon" value="icon-bed" class="colored-blue" type="radio" >
                                    <span class="text">家居类</span>
                                </label>
                                </div>
                            </div>
                            <p class="help-block col-sm-4 red">* 顶级分类勾选即可</p>
                        </div>
                       ...
                       <div class="form-group">
                                ...
                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                    <div class="checkbox">
                                        <?php if(is_array($categoryRecRes) || $categoryRecRes instanceof \think\Collection || $categoryRecRes instanceof \think\Paginator): $i = 0; $__LIST__ = $categoryRecRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$recRes): $mod = ($i % 2 );++$i;?>
                                        <label style="padding-right:10px;">
                                            <input type="checkbox" name="rec_pos[]" value="<?php echo $recRes['id']; ?>"
                                            <?php foreach($curRecRes as $v):
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <div class="radio" style="float:left; padding-right:10px;">
                                <label>
                                    <input name="show_cate" <?php if($categorys['show_cate'] == 1): ?> checked="checked" <?php endif; ?> value="1" class="colored-blue"  type="radio" >
                                    <span class="text">是 </span>
                                </label>
                            </div>
                            <div class="radio" style="float:left;">
                                <label>
                                    <input name="show_cate" <?php if($categorys['show_cate'] == 0): ?> checked="checked"<?php endif; ?> value="0" class="colored-blue" type="radio">
