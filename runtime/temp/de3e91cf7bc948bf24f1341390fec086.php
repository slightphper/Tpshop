<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"E:\phpStudy\WWW\TPshop/application/index\view\flow\flowCart2.htm";i:1541591956;s:63:"E:\phpStudy\WWW\TPshop/application/index\view\common\footer.htm";i:1541318748;}*/ ?>
<!doctype html>
<html>
<head>
...
<body class="bg-ligtGary">
    ...
    <div class="w w1200">
        <div class="fl">
            ...
            <div class="dsc-choie dsc-cm" ectype="dsc-choie"></div>
            <div class="dorpdown-layer" ectype="dsc-choie-content">
            </div>
        </div>
            <!-- 登录状态 -->
            <div class="txt-info" id="ECS_MEMBERZONE">
            <!-- 异步实时验证，在footer引入js文件(login.js) -->
            </div>
            <!-- 登录状态结束 -->
        </div>
...
<div class="header header-cart">
    <div class="w w1200">
        <div class="logo">
            <div class="logoImg"><a href="<?php echo url('index/Index/index'); ?>"><img src="__index__/img/logo.gif" /></a></div>
...
<!-- 收货人信息开始 -->
<div class="container">
    <form action="<?php echo url('index/Flow/flowCart3'); ?>" method="post" name="doneTheForm" class="validator" id="theForm">
        <div class="w w1200">
        <div class="checkout-warp">
            <div class="ck-step" id="consignee_list">
                <div class="ck-step-tit">
                    <h3>收货人信息</h3>
                    <a href="javascript:;" class="extra-r" target="_blank">管理收货人地址</a>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-value">
                    <input type="text" name="mobile_phone" value="" class="form-input">
                </div>
            </div>
            <div class="form-row">
            ...
            <div class="info">
                <div>
                    ...
                    <select class="form-input" id="s_county" name="district"></select>
            ...
            <div class="form-row">
                ...
                <div class="form-value">
                    <input type="text" name="zipcode" value="" class="form-input">
                </div>
            </div>
        </div>
        <!-- 收货人信息结束 -->
        <?php else: ?>
            ...
            <div class="form-row">
                <div class="form-label"><span class="red">*</span>收货人：</div>
                <div class="form-value">
                    <input type="text" name="name" value="<?php echo $userAddr['name']; ?>" class="form-input">
                    <div class="form_prompt"></div>
                </div>
            </div>
            <div class="form-row">
                <div class="form-label"><span class="red">*</span>手机号码：</div>
                <div class="form-value">
                    <input type="text" name="mobile_phone" value="<?php echo $userAddr['mobile_phone']; ?>" class="form-input">
                </div>
            </div>
            <div class="form-row">
                <div class="form-label"><span class="red">*</span>收货地址：</div>
            ...
            <div class="info">
                ...
                <script type="text/javascript">
                _init_area();
                $('select[name="province"]').val("<?php echo $userAddr['province']; ?>");
                $('select[name="province"]').change();
                $('select[name="city"]').val("<?php echo $userAddr['city']; ?>");
                $('select[name="city"]').change();
                $('select[name="district"]').val("<?php echo $userAddr['district']; ?>");
                </script>
            </div>
                <div id="show"></div>
            </div>
            <div class="form-row">
                <div class="form-label"><span class="red">*</span>详细地址：</div>
                <div class="form-value"><input type="text" name="address" value="<?php echo $userAddr['address']; ?>" class="form-input form-input-long"><div class="form_prompt"></div></div>
            </div>

            <div class="form-row">
                <div class="form-label"><span class="red">&nbsp;&nbsp;</span>邮政编码：</div>
                <div class="form-value">
                    <input type="text" name="zipcode" value="<?php echo $userAddr['zipcode']; ?>" class="form-input">
                </div>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="payment-warp">
            <div class="payment-list" ectype="paymentType">
                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
                    <span>
                        <input type="radio" name="distribution" value="顺丰" checked="checked" />&nbsp;顺丰   
                    </span>
                    <b></b>
                </div>
                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
                    <span>
                        <input type="radio" name="distribution" value="邮政" />&nbsp;邮政    
                    </span>
                    <b></b>
                </div>
            </div>
    ...
    <div class="ck-step-cont">
        <div class="payment-warp">
            <div class="payment-list" ectype="paymentType">
                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
                    <span>
                        <input type="radio" name="payment" value="1" checked="checked" />&nbsp;支付宝     
                    </span>
                    <b></b>
                </div>
                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
...
<div class="ck-step">
    <div class="ck-step-tit">
        <h3>商品信息</h3>
        <a href="<?php echo url('index/flow/flowCart1'); ?>" class="extra-r">返回购物车</a>
    </div>
    <div class="ck-step-cont">
        ...
        <div class="ck-goods-list">
                ...
                <div class="ck-goods-tit">
                    <div class="ck-store">
                        <a href="javascript:;" class="shop-name">联系客服</a>
        ...
        <!-- 商品信息列表 -->
        <?php if(is_array($checkGoods) || $checkGoods instanceof \think\Collection || $checkGoods instanceof \think\Paginator): $i = 0; $__LIST__ = $checkGoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?>
        <div class="cg-item">
            <div class="c-col cg-name">
                <input name="cart_info[]" type="hidden" value="0|36_813_2_1">
                <a href="javascript:;" target="_blank">
                    <!-- 商品缩略图 -->
                    <div class="p-img">
                        <img src="__uploads__/<?php echo $goods['mid_thumb']; ?>" width="48" height="48">
                    </div>
                    <!-- 商品名/属性 -->
                    <div class="p-info">
                        <div class="p-name"><?php echo $goods['goods_name']; ?></div>
                        <div class="p-attr"><?php echo $goods['goods_attrStr']; ?></div>
                    </div>
                </a>
            </div>
            <!-- 商品价格 -->
            ...
            <span>有货
                <input name="rec_number" type="hidden" id="36" value="0">
                <input name="shipping_prompt" type="hidden" id="36" value="1">
            </span>
        </div>
        <!-- 商品总价 -->
        <div class="c-col cg-sum"><em>¥</em><?php echo $goods['member_price'] * $goods['goods_num']; ?></div>
    ...
    <div class="order-summary">
        <div class="statistic">
            <div class="list">
                <span>共 <em><?php echo $goods_total['subtotal_number']; ?></em> 件商品，总商品金额：</span>
                <em class="price" id="warePriceId"><em>¥</em><?php echo $goods_total['goods_amount']; ?></em>
            </div>
            <div class="list">
                <span>应付总额：</span>
                <em class="price-total"><em>¥</em><?php echo $goods_total['goods_amount']; ?></em>
            </div>
        </div>
    </div>   
    <!-- 订单合计结束 -->
    ...
    <!-- 把传来的cart_value 发送给flowCart3 保存到order_goods表中 -->
    <input type="hidden" name="cart_value" value="<?php echo $attrStr; ?>">
