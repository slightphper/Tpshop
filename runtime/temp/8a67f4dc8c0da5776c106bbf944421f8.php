<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\phpStudy\WWW\TPshop/application/admin\view\category_rec\lst.htm";i:1539940295;s:60:"E:\phpStudy\WWW\TPshop/application/admin\view\common\top.htm";i:1540357346;s:61:"E:\phpStudy\WWW\TPshop/application/admin\view\common\left.htm";i:1541673520;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加分类推荐词" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('CategoryRec/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">推荐词名称</th>
                                <th class="text-center">关联分类推荐</th>
                                <th class="text-center">分类推荐词地址</th>
                        ...
                        <tbody>
                              ...
                              <tr>
                                ...
                                <td align="center"><?php echo $cate['category_rec']; ?></td>
                                <td align="center"><?php echo $cate['cate_name']; ?></td>
                                <td ><a href="<?php echo $cate['link_url']; ?>" target="_blank"><?php echo $cate['link_url']; ?></a></td>
                                <td align="center">
                                    <a href="<?php echo url('categoryRec/edit',array('id'=>$cate['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="del(this)" id="<?php echo $cate['id']; ?>" class="btn btn-danger btn-sm shiny">
