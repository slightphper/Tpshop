<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"E:\phpStudy\WWW\TPshop/application/index\view\goods\Goods.htm";i:1541319087;s:63:"E:\phpStudy\WWW\TPshop/application/index\view\common\header.htm";i:1541318416;s:62:"E:\phpStudy\WWW\TPshop/application/index\view\common\right.htm";i:1539517953;s:63:"E:\phpStudy\WWW\TPshop/application/index\view\common\footer.htm";i:1541318748;}*/ ?>
<!doctype html>
<html>
<head>
...
<script type="text/javascript">
var ajax_add_to_cart = "<?php echo url('index/Flow/addToCart'); ?>"; //添加到购物车    js:common.js
var ajax_cart_url = "<?php echo url('index/Flow/flowCart1'); ?>";      //转跳到购物车页面  js:common.js
...
<div class="preview" if="preview">
	<div class="gallery_wrap">
		<a href="__uploads__/<?php echo $goodsInfo['og_thumb']; ?>" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: img-hover; selectors-change: mouseover; zoom-distance: 10;zoom-width: 400; zoom-height: 474;"><img src="__uploads__/<?php echo $goodsInfo['big_thumb']; ?>" id="J_prodImg" alt="<?php echo $goodsInfo['goods_name']; ?>"></a>
	</div>
	<div class="spec-list">
		<a href="javascript:void(0);" class="spec-prev"><i class="iconfont icon-left"></i></a>
		<div class="spec-items">
			<ul>
				<?php if(is_array($goodsPhotoRes) || $goodsPhotoRes instanceof \think\Collection || $goodsPhotoRes instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsPhotoRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mid_photos): $mod = ($i % 2 );++$i;?>	            	 
            	<li>
				<a href="__uploads__/<?php echo $mid_photos['og_photo']; ?>" rel="zoom-id: Zoomer" rev="__uploads__/<?php echo $mid_photos['big_photo']; ?>" >
				<img src="__uploads__/<?php echo $mid_photos['mid_photo']; ?>" alt="<?php echo $goodsInfo['goods_name']; ?>" width="58" height="58" />
				</a>
				</li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
...
<div class="si-tit">原 价¥</div>
<div class="si-warp">
    <strong class="shop-price" id="" ectype="SHOP_PRICE"><?php echo $goodsInfo['shop_price']; ?></strong>
    <span class="si-tit">会员价</span>
    <strong class="member-price" id="ECS_SHOPPRICE" ectype="SHOP_PRICE"></strong>
</div>
                </div>
...
<div class="si-warp">
        ...
        <div class="summary-item is-integral">
        	...
        	<div class="si-warp">
				<!-- <label class="radiocheck"><input checked="checked" type="radio" name="color" value="黑色">黑色<i></i></label> -->
				<?php if(is_array($radioAttr) || $radioAttr instanceof \think\Collection || $radioAttr instanceof \think\Paginator): $i = 0; $__LIST__ = $radioAttr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$attr_value): $mod = ($i % 2 );++$i;?>
				<label <?php if($i == 1): ?> class="radiocheck" <?php endif; ?>>
					<input type="radio" name="attr_<?php echo $attr_value['attr_id']; ?>" value="<?php echo $attr_value['id']; ?>"
					<?php if($i == 1): ?> checked="checked"<?php endif; ?>>
					<?php echo $attr_value['attr_value']; if($attr_value['attr_price'] > 0): ?>[加<?php echo $attr_value['attr_price']; ?>元]<?php endif; ?><i></i>
				</label>
				<?php endforeach; endif; else: echo "" ;endif; ?>
        	</div>
   		</div>
    ...
    <script type="text/javascript">
      ...
      $.ajax({
      	...
      	success:function(data){
      		$("#ECS_SHOPPRICE").html('<em>¥</em>'+data);
      	}
      });
    //单选属性的选中及其兄弟元素的去除选中 
	$(".si-warp label").click(function(){
		$(this).addClass('radiocheck').siblings().removeClass('radiocheck');
		$(this).children('input').attr('checked',true);
		$(this).siblings().children('input').attr('checked',false);
		// return false;  //去掉，添加购物车属性会出错
	});
    </script>
	<script type="text/javascript">
	//商品详情
