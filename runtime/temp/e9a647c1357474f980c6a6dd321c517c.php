<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"E:\phpStudy\WWW\TPshop\public/../application/admin\view\attr\lst.htm";i:1538883488;s:70:"E:\phpStudy\WWW\TPshop\public/../application/admin\view\common\top.htm";i:1540357346;s:71:"E:\phpStudy\WWW\TPshop\public/../application/admin\view\common\left.htm";i:1540261124;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
		...
		<div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    ...
                    <li>
                        <a href="<?php echo url('Type/lst'); ?>">返回所属类型</a>
                    </li>
...
<button attr="button" tooltip="添加商品属性" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Attr/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">商品所属属性</th>
                                <th class="text-center">商品属性内容</th>
                        ...
                        <tbody>
                              ...
                              <tr>
                                ...
                                <td align="center"><?php if($attr['attr_type'] == 1): ?>单选<?php else: ?>唯一<?php endif; ?>
                                </td>
                                <td align="center"><?php echo $attr['type_name']; ?></td>
                                <td ><?php echo $attr['attr_values']; ?></td>
                                <td align="center">
                                     <a href="<?php echo url('attr/edit',array('id'=>$attr['id'])); ?>" class="btn btn-azure btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('attr/del',array('id'=>$attr['id'])); ?>')" class="btn btn-danger btn-sm shiny">
